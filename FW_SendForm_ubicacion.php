...
// CONFIG
// Redirect pages
$successPage = "index.html"; // Relative path for page to redirect to on success
...
$subject = "forma de contacto conebeam"; // Subject of the E-Mail
$from = ""; // From address if server requires it or if E-Mail address is optional
$name = "forma de contacto conebeam"; // The name of the sender, if required
...
$errorStrings = array(
	...
	4 => 'sendForm41816', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm41816']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm41816']))))
{
	// Probably not
	appendError(4);
}
