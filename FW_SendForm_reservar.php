...
// CONFIG
// Redirect pages
$successPage = "envio.html"; // Relative path for page to redirect to on success
$errorPage = "index.html"; // Relative path for page to redirect to on error, error numbers will be in a GET variable

// E-Mail
$recipient = "jgalicia@mac.com"; // Address to deliver form to
$subject = "Reservar Curso Conebeam"; // Subject of the E-Mail
$from = ""; // From address if server requires it or if E-Mail address is optional
$name = "Reservar Curso Conebeam"; // The name of the sender, if required
...
$input_vars = array(
	...
	'¿Es_endodoncista_o_Estudiante?' => array(
		'title' => '¿Es endodoncista o Estudiante?',
		'required' => '0'
	),
	'¿Es_endodoncista_o_Estudiante?' => array(
		'title' => '¿Es endodoncista o Estudiante?',
...
$errorStrings = array(
	...
	4 => 'sendForm98104', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm98104']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm98104']))))
{
	// Probably not
	appendError(4);
}
